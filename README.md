...
This project was done as part of the Machine Learning class within my BS program at UCSB. It investigates the research by Hristos Tyralis and Georgia Papacharalampous on the use of Random Forest machine learning models for forecasting, comparing them with contemporary procedures such as the Box-Jenkins methodology and Auto ARIMA.
